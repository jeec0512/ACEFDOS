<%@ Page Title="" Language="C#" MasterPageFile="~/flota/mpFlota.master" AutoEventWireup="true" CodeFile="flota.aspx.cs" Inherits="flota_flota" EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:150%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Flota</legend>
             ...
             <iframe id="ifControlEst" src=" http://www.aneta.org.ec:9095/flota/site/home.an?prmusrid=152" runat="server" width="150%" height="800px" frameborder="0"></iframe>

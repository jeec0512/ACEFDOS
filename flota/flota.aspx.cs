...
public partial class flota_flota : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //string controlEstudiantil = " http://192.168.1.124:8080/flota/site/home.an?prmusrid=" + userId;
             string controlEstudiantil = " http://www.aneta.org.ec:9095/flota/site/home.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        //sUrl = "http://www.aneta.org.ec:9095/AnetaFacturacionEsc/site/home.jsf?prmusrid=" + Username;

        sUrl = "  http://www.aneta.org.ec:9095/flota/site/home.an?prmusrid=" + userId;

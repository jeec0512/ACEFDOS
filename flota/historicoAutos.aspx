<%@ Page Title="" Language="C#" MasterPageFile="~/flota/mpFlota.master" AutoEventWireup="true" CodeFile="historicoAutos.aspx.cs" Inherits="flota_historicoAutos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:150%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Histórico vehículos</legend>

                <!--<asp:Button ID="btnNotas" runat="server" Text="Control estudiantil" CssClass="btnProceso" 
                    OnClick="btnNotas_Click" />-->
             <iframe id="ifControlEst" src=" http://www.aneta.org.ec:9095/flota/site/reporte/historicoauto.an?prmusrid=152" runat="server" width="150%" height="800px" frameborder="0"></iframe>

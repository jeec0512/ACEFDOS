...
public partial class Valija_recibirValija : System.Web.UI.Page
{
    ...
    protected void btnConsultar_Click()
    {
        ...
        else
        {
            ...
            {
                lblMensaje.Text = "Se ha registrado el recibido y la posterior entrega, no se puede modificar";
                if (listarEnvios())
                {
                    pnDetallePagos.Visible = true;
                    pnMenu.Visible = false;
    ...
    protected bool estadoCierre()
    {
        ...
        /*****************************************/
         DateTime lfecha = DateTime.Today;
                ...
                string lnumero = 'R' + lsucursal + dia + mes + ano;
   ...
   /*             var concultaDetEgresos = dc.sp_ConsultaValijaDetalleRecibe(laccion, lnumero);
    ...
    protected void llenarListados()
    {
        ...
        var cColaborador = from Ter in dc.tbl_colaborador
                           where Ter.sucursal== lsuc
                           orderby Ter.sucursal+Ter.apellidos
                           select new
                           {
                               cedula = Ter.Cedula,
                               nombres = Ter.apellidos.Trim() + " " + Ter.nombres.Trim() + " " + Ter.sucursal.Trim()
                           };

        ddlEmisor.DataSource = cColaborador;
        ddlEmisor.DataBind();

        ListItem liTercero = new ListItem("Seleccione quién recepta toda la valija (Receptor) ", "-1");
        ...
        ListItem liReceptor = new ListItem("Seleccione a quién se le entrega el paquete", "-1");
        ...
        ListItem liSucursal = new ListItem("Seleccione la sucursal que envió ", "-1");
        ...
        ListItem liCco = new ListItem("Seleccione Departamento que recibe ", "-1");
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        Page.ClientScript.RegisterStartupScript(this.GetType(), "Scripts", "<script>window.open('reciboValija.aspx','','width=800,height=500') </script>");

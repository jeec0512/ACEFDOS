...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <iframe id="ifFacturacion" src=" http://www.aneta.org.ec:9094/AnetaFacturacionEsc/site/home.jsf?prmusrid=SISJEEC" runat="server" width="100%" height="800px" frameborder="0"></iframe>
        </fieldset>
    </asp:Panel>
</asp:Content>

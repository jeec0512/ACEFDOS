...
public partial class Contabilidad_AWAContabilidad : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = " http://www.aneta.org.ec:7070/awa/" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://www.aneta.org.ec:7070/awm/{*usuarios}";

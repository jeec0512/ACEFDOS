...
public partial class Contabilidad_cntIngresos : System.Web.UI.Page
{
    ...
    protected void  listarFechas()
    {
        ...
        var cfechas = dc.sp_ListarEtiquetaDiariosContables("VERFECHASI",ano,periodo);
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        ...
        if (pasa)
        {
            dc.sp_abmEtiquetaDiariosContables(accion, 0, "I", "", fechaInicio, fechaFin, usuarioIdCrea, usuarioIdMod, fechaCrea, fechaMod, estado, semana, fechaExp, ano, periodo);
            btnCancelar_Click();
        }
        else 
        {

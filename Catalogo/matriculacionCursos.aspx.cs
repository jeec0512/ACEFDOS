...
public partial class Catalogo_matriculacionCursos : System.Web.UI.Page
{
    ...
    protected void listarFechasMatriculas() {
        grvAutos.DataSource = ds.sp_abmCursoMatricula("TODOS", 0, 0, DateTime.Now, DateTime.Now, 0, DateTime.Now, 0);
        grvAutos.DataBind();

        ddlCurso.DataSource = ds.sp_abmCurso("TODOSACT", 0, 0, "", "", DateTime.Now, DateTime.Now, false, "", DateTime.Now);
        ddlCurso.DataBind();
    }
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ds.sp_abmCursoMatricula(Accion, id, cur_id, fechaIni, fechaFin, usuid, DateTime.Now, usuid);
            }
    ...
    {
        bool pasa = true;
        string lfechaIni = Convert.ToString(fechaIni).Trim();
        string lfechaFin = Convert.ToString(fechaFin).Trim();

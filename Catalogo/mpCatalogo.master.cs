...
public partial class Catalogo_mpCatalogo : System.Web.UI.MasterPage
{
    ...
    protected void calificarOpciones()
    {
        ...
        menu = "CATALOGO";
			...
			submenu = "MATRICUCUR";
            lMatriCur.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

            submenu = "REGAMBIENTAL";
            lRegistroAmbiental.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

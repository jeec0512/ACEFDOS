...
public partial class Catalogo_registroAmbiental : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = "http://www.aneta.org.ec:9095/ambiental/site/home.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://www.aneta.org.ec:9095/ambiental/site/home.an?prmusrid={*usuarios}";

<%@ Page Title="" Language="C#" MasterPageFile="~/Socio/mpSocio.master" AutoEventWireup="true" CodeFile="estadoSocio.aspx.cs"
    Inherits="Socio_estadoSocio" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Estado del socio</legend>
            ...
            <asp:Panel ID="pnHistorialMembrecias" CssClass="pnPeqSoc" runat="server" 
                ...
                <asp:GridView ID="grvHistorialMembrecias"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cónyugue">
                            <ItemTemplate>
                                <%# Eval("conyugue") %>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Panel ID="pnDigitalizar" CssClass="" runat="server" Visible="false">
        ...
        <fieldset id="Fieldset2" class="fieldset-principal">
            <legend>Contrato del socio</legend>

            <p>Your Browser does not support iframes</p>
            <article>
                <iframe width="90%" height="315" src="http://www.aneta.org.ec:8087/CONTRATODIGITAL/webform3.aspx" frameborder="0"

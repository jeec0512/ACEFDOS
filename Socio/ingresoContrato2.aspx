<%@ Page Title="" Language="C#" MasterPageFile="~/Socio/mpSocio.master" AutoEventWireup="true" CodeFile="ingresoContrato2.aspx.cs"
    Inherits="Socio_ingresoContrato2" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="pnGuardar" CssClass="pnPeq" runat="server" Wrap="False">
                <asp:Button
                    ID="btnGuardar" runat="server" CssClass=btnProceso Text="Grabar" Visible="true" OnClick="btnGuardar_Click" />
                <asp:Button
                    ID="btnCancelar" runat="server" CssClass=btnProceso Text="Regresar" Visible="true" OnClick="btnCancelar_Click" />
                <asp:Button
                    ID="btnDigitalizar" runat="server" CssClass=btnProceso Text="Digitalizar" Visible="true" OnClick="btnDigitalizar_Click"/>


                 <asp:TextBox ID="txtCedulaDig" runat="server" CssClass="txtPeq" Enabled="true"></asp:TextBox>
                 <asp:TextBox ID="txtContratoDig" runat="server" CssClass="txtPeq" Enabled="true"></asp:TextBox>

                <asp:Button
                    ID="btnActivar" runat="server" CssClass=btnProceso Text="Activar" Visible="true" OnClick="btnActivar_Click"/>
            </asp:Panel>
        </fieldset>
        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <fieldset id="Fieldset7" class="fieldset-principal">
                ...
                <asp:Panel ID=Panel8 runat="server" CssClass="pnFormSocio" GroupingText="Datos personales" ForeColor="#0033cc">
                    ...
                    <asp:TextBox ID="txtNombresCon" runat="server" CssClass="txtPeq"></asp:TextBox>
                    <asp:Label ID="lblApellidosCon" runat="server" AssociatedControlID="txtApellidosCon" CssClass="lblPeq"
                        Text="Apellidos/Cóny."></asp:Label>
                    <asp:TextBox ID="txtApellidosCon" runat="server" CssClass="txtPeq"></asp:TextBox>
            ...
            <fieldset id="Fieldset4" class="fieldset-principal">
                ...
                <asp:Panel ID="pnMembrecia" runat="server" CssClass="pnFormSocio" GroupingText="Datos membrecía" ForeColor="#0033cc"
                    Enabled="true">
                ...
                <asp:Panel ID=Panel7 runat="server" CssClass="pnFormSocio" GroupingText="Tarjeta del socio" ForeColor="#0033cc">
                ...
                <asp:Panel ID=Panel12 runat="server" CssClass="pnFormSocio" GroupingText="Guía de remisión al socio"
                    ForeColor="#0033cc">
    ...
    <asp:Panel ID="pnDigitalizar" CssClass="" runat="server" Visible="false">

        <fieldset id="Fieldset2" class="fieldset-principal">
            <legend>Digitalizar contratos del socio</legend>

            <p>Your Browser does not support iframes</p>
            <article>
                <iframe width="90%" height="315" src="http://www.aneta.org.ec:8087/CONTRATODIGITAL/" frameborder="0"
            ...
            <p></p>
            <asp:Button
                    ID="btnRegresar" runat="server" CssClass=btnProceso Text="Regresar" Visible="true" OnClick="btnRegresar_Click" />

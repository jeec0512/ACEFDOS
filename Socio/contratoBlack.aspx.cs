...
public partial class Socio_contratoBlack : System.Web.UI.Page
{
    ...
    string conn4 = System.Configuration.ConfigurationManager.ConnectionStrings["bddComprobantesConnectionString"].ConnectionString;

    DataComisionesDataContext di = new DataComisionesDataContext();
    ...
    protected void guardarMmebresia()
    {
       ...
       // dc.sp_abmRegistroComisiones(laccion,0,Convert.ToInt32(ltipo_membr),Convert.ToInt32(lvendedor_membr),lfactura,
    }
    ...
    public void enviarCorreoHtml()
    {
        ...
        string cedula = "CI: "+txtRucTar.Text.Trim();
        string fechaInicio = "SOCIO DESDE: " + txtFechaInicio.Text;
        string fechaFin = "VENCE: " + txtVencimiento.Text;
        string contrato = "Cont: " + txtNumContratoTar.Text;
        string factura = "FaMe:" + txtNumFactura.Text.Trim();
        string facturaTit = txtNumFactura.Text.Trim();

        string factTitulo = txtNumFactura.Text.Trim();
        ...
        string bienvenida = nombreSocio + " ahora es socio de servicios de ANETA y puede acceder a sus beneficios con su tarjeta virtual ";
        ...
        {
            case "E":
                caminoLogo = "~//Plantillas//membresia3mesesBlack.html";
                ...
                break;
            case "S":
                caminoLogo = "~//Plantillas//membresiaStandarBlack.html";
                ...
                break;
            case "M":
                caminoLogo = "~//Plantillas//membresiaMotoBlack.html";
                membresia = "Membresía: " + "MOTO";

                /*IMAGENES*/

                Filename1 = Server.MapPath("~//Images//socios//black//motoFront1_387.jpg");
                Filename2 = Server.MapPath("~//Images//socios//black//motoFront2_147.jpg");
                Filename3 = Server.MapPath("~//Images//socios//black//motoFront3_236.jpg");
                Filename4 = Server.MapPath("~//Images//socios//black//motoBack_387.jpg");


                break;
            case "T":
                caminoLogo = "~//Plantillas//membresiaTaxiBlack.html";
                membresia = "Membresía: " + "TAXI";

                /*IMAGENES*/

                Filename1 = Server.MapPath("~//Images//socios//black//taxiFront1_387.jpg");
                Filename2 = Server.MapPath("~//Images//socios//black//taxiFront2_147.jpg");
                Filename3 = Server.MapPath("~//Images//socios//black//taxiFront3_236.jpg");
                Filename4 = Server.MapPath("~//Images//socios//black//taxiBack_387.jpg");

                break;
            case "P":
                caminoLogo = "~//Plantillas//membresiaPremiumBlack.html";
                membresia = "Membresía: " + "PREMIUM";
                
                /*IMAGENES*/

                Filename1 = Server.MapPath("~//Images//socios//black//premiumBlackFront1_387.jpg");
                Filename2 = Server.MapPath("~//Images//socios//black//premiumBlackFront2_147.jpg");
                Filename3 = Server.MapPath("~//Images//socios//black//premiumBlackFront3_232.jpg");
                Filename4 = Server.MapPath("~//Images//socios//black//premiumBlackBack_387.jpg");

                break;

            case "D":
                caminoLogo = "~//Plantillas//membresiaPremiumBlack2Anos.html";
            ...
            case "U":
                caminoLogo = "~//Plantillas//membresiaPremiumBlack3Anos.html";
                ...
                break;
            case "R":
                caminoLogo = "~//Plantillas//membresiaProautoBlack.html";
        ...
        emailHtml.Replace("titulo", titulo);
        emailHtml.Replace("bienvenida", bienvenida);
       ...
       // emailHtml.Replace("codigoQR", codigoQR);
        ...
        string tituloEmail = "TARJETA VIRTUAL ANETA de: " + nombreSocio + "  N°: " + facturaTit;

        if (envio == "1")
        {
            destinatarios = txtEmailDom.Text.Trim().ToLower();
            cc = txtEmail.Text.Trim().ToLower() + "," + "socios@aneta.org.ec";
        }

        if (envio == "2")
        {
            destinatarios = txtEmail.Text.Trim().ToLower();
            cc = txtEmailDom.Text.Trim().ToLower() + "," + "socios@aneta.org.ec";
        }
        ...
        string anexo = "";//Server.MapPath("~//images//iconos//logo2.jpg");
         ...
         //new email().enviarCorreo("192.168.1.101", 25, "socios@aneta.org.ec", "aneta54", "MEMBRESIAS-ANETA", destinatarios, cc, "TARJETA VIRTUAL ANETA", anexo, emailHtml.ToString(), Filename1, Filename2, Filename3, Filename4);
       ...
       // if (new email().enviarCorreo("smtp.gmail.com", 25, "socios@aneta.org.ec", "lxane2k11", "MEMBRESIAS-ANETA", destinatarios, cc, tituloEmail , anexo, emailHtml.ToString(), Filename1, Filename2, Filename3, Filename4))
        if (new email().enviarCorreo("192.168.1.110", 25, "socios@aneta.org.ec", "aneta54", "MEMBRESIAS-ANETA", destinatarios, cc, tituloEmail, anexo, emailHtml.ToString(), Filename1, Filename2, Filename3, Filename4))
         {
             lblMsg.Text = lblMsg.Text + " Se envío el correo electrónico";
             lenvio = false;
         }
         else
         {
        ...
        //email.enviarCorreo("192.168.1.101", 25, "socios@aneta.org.ec", "aneta54", "MEMBRESIAS-ANETA", destinatarios, cc, "TARJETA VIRTUAL ANETA", anexo, emailHtml.ToString(), Filename1, Filename2, Filename3, Filename4);
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
		...
		/*	
			try
            {
                DateTime fecAfil = Convert.ToDateTime(txtFechaInicio.Text);
                DateTime fecVenc = Convert.ToDateTime(txtVencimiento.Text);
            }
            catch (Exception mens)
            {

                //Response.Redirect("~/ingresar.aspx");
                lblMensaje.Text = "Fechas mal ingresadas" + mens;
            }
        */
		lpasa = false;

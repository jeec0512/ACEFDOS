...
public partial class Ingreso_imprimirAsientoIngresos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (diferencia != 0)
        {
            ...
            Session["pDiferencia"] = diferencia;
            contenedor.Visible = false;
            return;
            // Response.Redirect("~/Ingreso/resumenFacturacion.aspx");
        }
        else {
    ...
    protected void cierreCaja()
    {
        ...
        var cEgresos = dc.sp_verContabilizacionVentas2(laccion, lFechaInicio, lFechaFin, lsucursal);

...
#region CALIFICAR OPCIONES
    protected void calificarOpciones()
    {
        ...
        boton = string.Empty;
                ...
                submenu = "FACTELECT";
                lFactElect.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

                submenu = "VERIFFACT";
                lVerifFact.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);
                ...
                submenu = "NOTASCREDITO";
                lNotasCredito.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

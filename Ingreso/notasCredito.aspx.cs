...
public partial class Ingreso_notasCredito : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = "http://192.168.1.124:8080/escuelaweb/site/ncredito.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://192.168.1.124:8080/escuelaweb/site/ncredito.an?prmusrid={*usuarios}";

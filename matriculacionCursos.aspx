<%@ Page Title="" Language="C#" MasterPageFile="~/Catalogo/mpCatalogo.master" AutoEventWireup="true" CodeFile="matriculacionCursos.aspx.cs" Inherits="matriculacionCursos" EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnActualizacion" runat="server" Visible="true" Style="margin-top: 1rem;">
        ...
        <asp:Panel ID="pnAuto" runat="server">
            <fieldset id="fsAuto">
                ...
                <asp:Panel ID="pnCurso" runat="server" CssClass="pnFormDdl" Style="margin-bottom: 1rem;" Visible="false">
                    <asp:Label ID="lblCurso" CssClass="lblPeq" runat="server" Text="Curso" Visible="true"></asp:Label>
                    <asp:DropDownList ID="ddlCurso" DataTextField="Curso" DataValueField="Curso" runat="server"
                        AutoPostBack="True" 

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imprimirAutoconsumos.aspx.cs" Inherits="Egreso_imprimirAutoconsumos" %>
...
<body>
    ...
    <fieldset id="Fieldset1" class="fieldset-principal">
                ...
                <asp:Panel ID="Panel1" CssClass="" runat="server" Visible="true" Width="50%">
                    ...
                    <asp:Label ID="lblSubTitulo" runat="server" Text="REPORTE DE AUTOCONSUMOS"></asp:Label><br />

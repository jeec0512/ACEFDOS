<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cierre.aspx.cs" Inherits="Tesoreria_cierre" %>
    ...
    <div>
     <asp:Panel
                ...
                <asp:Label
                    ID="lblSubTitulo"
                    runat="server"
                    Text="Cierre diario"></asp:Label><br />
                <br />
                <asp:Label
                    ID="lblFechas"
                    runat="server"
                ...
                <br />
                 <asp:Label
                    ID="lblFirmas"
                    runat="server"
                    Text="Firmas:"></asp:Label><br /><br /><br /><br />

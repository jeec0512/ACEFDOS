...
public partial class Escuela_diego2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = " http://192.168.1.124:8080/escuelaweb/control/home.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = "  http://192.168.1.124:8080/escuelaweb/control/home.an?prmusrid=" + userId;

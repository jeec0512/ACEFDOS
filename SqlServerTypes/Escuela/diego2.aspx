<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="diego2.aspx.cs" Inherits="Escuela_diego2"  EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:110%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Comprobantes electrónicos</legend>
             ...
             <iframe id="ifControlEst" src=" http://192.168.1.124:8080/escuelaweb/control/home.an?prmusrid=64" runat="server" width="100%" height="800px" frameborder="0"></iframe>

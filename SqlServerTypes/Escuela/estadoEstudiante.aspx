<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="estadoEstudiante.aspx.cs" Inherits="Escuela_estadoEstudiante" EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:110%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Información del alumno</legend>
             ...
             <iframe id="ifControlEst" src=" http://192.168.1.124:8080/escueladev/consultas/home.an?prmusrid=166" runat="server" width="100%" height="800px" frameborder="0"></iframe>

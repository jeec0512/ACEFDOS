...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="Panel1" CssClass="" runat="server" Visible="false">

        <fieldset id="Fieldset2" class="fieldset-principal">
            <legend>Certificado psicopráctico</legend>
            <iframe id="ifFacturacion" src=" http://aneta.org.ec:5090/acefdos/(S(cdnllygabpz5pg03y51vudcx))/Escuela/imprimirSicopractico.aspx" runat="server" width="100%" height="800px" frameborder="0"></iframe>
        </fieldset>
    </asp:Panel>

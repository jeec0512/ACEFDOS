<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="recuperacion.aspx.cs" Inherits="Escuela_recuperacion" EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:110%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Comprobantes electrónicos</legend>
             ...
             <iframe id="ifControlEst" src="http://www.aneta.org.ec:8080/asighor/WFReportePetrinovic.aspx?prmfid=94465" runat="server" width="100%" height="800px" frameborder="0"></iframe>

<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="ingresoNotas.aspx.cs" Inherits="Escuela_ingresoNotas" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnActualizacion" runat="server">
        ...
        <asp:Panel ID="pnAsignacion" runat="server">
            <fieldset id="fsAsignacion">
                <legend>Creación de horarios</legend>
                ...
                <asp:Panel ID="pnBotonera" runat="server" CssClass="pnFormBotonera">
                    <asp:Button ID="btnGuardar" runat="server" Text="Ver listado" CssClass="btnForm"
    ...
    <asp:Panel ID="pnHorarios" runat="server">
        <fieldset id="fsHorarios">
            <legend>Horarios creados</legend>

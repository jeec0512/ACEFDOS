...
public partial class flota_licenciaConducir : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["pCamino"] = "../admArchivos/licenciasConducir/";
        Session["pFormulario"] = "licenciaConducir.aspx";
    ...
    protected void perfilUsuario()
    {
        try
        {
            ...
            var cSucursal = dc.sp_listarSucursal2("", "", nivel, 0, sucursal,"");
    ...
    {
        Response.Redirect("~/flota/verImagen.aspx?ImageURL=" + ((ImageButton)sender).ImageUrl);
    }

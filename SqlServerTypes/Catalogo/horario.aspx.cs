...
public partial class Catalogo_horario : System.Web.UI.Page
{
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        ...
        bool pasa = validarDatos(sucursal, modalidad,horaInicio,horaFin, activo, usuario, fechaModificacion,materia);
        ...
        {
            /*GUARDAR INFORMACION*/
            ds.sp_abmHorario(Accion, hor_id, 0, horaInicio,horaFin, Convert.ToBoolean(nActivo), usuario, Convert.ToDateTime(fechaModificacion),sucursal, modalidad,materia );
            blanquearObjetos();
    ...
    protected void grvHorarioDetalle_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "eliReg")
        {
            ...
            try
            {
                lblMensaje.Text = "elimina registro" + lidCurso;
                ds.sp_abmHorario("BORRAR", lidCurso, 0, "", "", false, "", DateTime.Now, "", 0, 0);
            }

<%@ Page Title="" Language="C#" MasterPageFile="~/Socio/mpSocio.master" AutoEventWireup="true" CodeFile="contratoBlack.aspx.cs" Inherits="Socio_contratoBlack"  EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnMensaje2" CssClass="" runat="server" Visible="true">
        <asp:Label ID="lblMensaje" runat="server" Text="" Visible="true" ForeColor="Red"></asp:Label>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <fieldset id="Fieldset4" class="fieldset-principal">
                ...
                <asp:Panel ID="pnMembrecia" runat="server" CssClass="pnFormSocio" GroupingText="Datos membrecía" ForeColor="#0033cc"  Enabled="true">

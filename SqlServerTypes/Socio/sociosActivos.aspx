<%@ Page Title="" Language="C#" MasterPageFile="~/Socio/mpSocio.master" AutoEventWireup="true" CodeFile="sociosActivos.aspx.cs" Inherits="Socio_sociosActivos" EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnSocios" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <asp:GridView ID="grvSocios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <asp:TemplateField HeaderText="Celular" ItemStyle-Wrap="False">
                    <ItemTemplate>
                        <%# Eval("CELULAR_CONTAC") %>
                    </ItemTemplate>
                </asp:TemplateField>

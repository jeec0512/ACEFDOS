...
public partial class Socio_tablaMembresias : System.Web.UI.Page
{
    ...
    protected void listaReportesVendedor(string ltipo, string laccion1, string laccion2)
    {
        ...
        if (ltipo == "1")
        {
            if (tipo == 3 || tipo == 4)
            {
                ...
                grvVendedorTotal.DataSource = dc.sp_membreisasxVendedor(laccion1, lsucursal, lfechaInicio, lfechaFin);
        ...
        if (ltipo == "2")
        {
            grvVendedor.DataSource = dc.sp_membreisasxVendedor(laccion2, lsucursal, lfechaInicio, lfechaFin);

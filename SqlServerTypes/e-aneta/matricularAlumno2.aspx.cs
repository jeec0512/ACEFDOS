...
public partial class Escuela_matricularAlumno2 : System.Web.UI.Page
{
    ...
    {
        int modalidad = Convert.ToInt32(ddlModEducVial.SelectedValue);
        var cCurso = ds.sp_abmCurso("TODOS", 0, modalidad, "", "", DateTime.Today, DateTime.Today, false, "", DateTime.Today);

        ddlCurEducVial.DataSource = cCurso;
        ddlCurEducVial.DataBind();

        ListItem listCon = new ListItem("Seleccione Curso", "-1");

        ddlCurEducVial.Items.Insert(0, listCon);

    }

    protected void listarCursoMec()
    {
        int modalidad = Convert.ToInt32(ddlModMecanica.SelectedValue);
        var cCursoM = ds.sp_abmCurso("TODOS", 0, modalidad, "", "", DateTime.Today, DateTime.Today, false, "", DateTime.Today);

        ddlCurMecanica.DataSource = cCursoM;
        ddlCurMecanica.DataBind();

        ListItem listCon = new ListItem("Seleccione Curso", "-1");

        ddlCurMecanica.Items.Insert(0, listCon);
    ...
    {
        int modalidad = Convert.ToInt32(ddlModPsicologia.SelectedValue);
        var cCurso = ds.sp_abmCurso("TODOS", 0, modalidad, "", "", DateTime.Today, DateTime.Today, false, "", DateTime.Today);

        ddlCurPsicologia.DataSource = cCurso;
        ddlCurPsicologia.DataBind();

        ListItem listCon = new ListItem("Seleccione Curso", "-1");

        ddlCurPsicologia.Items.Insert(0, listCon);

    }

    protected void listarCursoPA()
    {
        int modalidad = Convert.ToInt32(ddlModPrimerosAuxilios.SelectedValue);
        var cCurso = ds.sp_abmCurso("TODOS", 0, modalidad, "", "", DateTime.Today, DateTime.Today, false, "", DateTime.Today);

        ddlCurPrimerosAuxilios.DataSource = cCurso;
        ddlCurPrimerosAuxilios.DataBind();

        ListItem listCon = new ListItem("Seleccione Curso", "-1");

        ddlCurPrimerosAuxilios.Items.Insert(0, listCon);

    }

    protected void listarCursoPr()
    {
        int modalidad = Convert.ToInt32(ddlModPractica.SelectedValue);
        var cCurso = ds.sp_abmCurso("TODOS", 0, modalidad, "", "", DateTime.Today, DateTime.Today, false, "", DateTime.Today);

        ddlCurPractica.DataSource = cCurso;
        ddlCurPractica.DataBind();

        ListItem listCon = new ListItem("Seleccione Curso", "-1");

        ddlCurPractica.Items.Insert(0, listCon);
    ...
    protected void horarioEducacionVial()
    {
        ...
        int modalidad = Convert.ToInt32(ddlModEducVial.SelectedValue);
        int curso = Convert.ToInt32(ddlCurEducVial.SelectedValue);
    ...
    protected void horarioMecanica()
    {
        ...
        string sucursal = ddlEscuela.SelectedValue;
        int modalidad = Convert.ToInt32(ddlModMecanica.SelectedValue);
        int curso = Convert.ToInt32(ddlCurMecanica.SelectedValue);
    ...
    protected void horarioPrimerosAuxilios()
    {
        ...
        string sucursal = ddlEscuela.SelectedValue;
        int modalidad = Convert.ToInt32(ddlModPrimerosAuxilios.SelectedValue);
        int curso = Convert.ToInt32(ddlCurPrimerosAuxilios.SelectedValue);
    ...
    protected void horarioPsicologia()
    {
        ...
        string sucursal = ddlEscuela.SelectedValue;
        int modalidad = Convert.ToInt32(ddlModPsicologia.SelectedValue);
        int curso = Convert.ToInt32(ddlCurPsicologia.SelectedValue);
    ...
    protected void horarioPractica()
    {
        ...
        string sucursal = ddlEscuela.SelectedValue;
        int modalidad = Convert.ToInt32(ddlModPractica.SelectedValue);
        int curso = Convert.ToInt32(ddlCurPractica.SelectedValue);

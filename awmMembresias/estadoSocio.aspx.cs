...
public partial class awmMembresias_estadoSocio : System.Web.UI.Page
{
    ...
    protected void imgBuscar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (lopcion == "0")
        {
            ...
            grvHistorialMembrecias.DataSource = dc.sp_buscaMembrecias_awm(laccion, lcedula);
    ...
    protected void grvClientes_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        grvFacturasEmitidas.DataSource = dc.sp_buscaFacturas(laccion, lcedula);

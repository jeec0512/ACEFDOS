...
public partial class awmMembresias_sociosFacturados : System.Web.UI.Page
{
    ...
    protected void listaReportes(string ltipo, string laccion1, string laccion2)
    {
        ...
        if (ltipo == "1")
        {
            if (tipo == 3 || tipo == 4)
            {
                laccion1 = "DETALLE";
                laccion2 = "TOTAL";
                grvSocios.DataSource = dc.sp_RepSocios_awm("servername","remote proc transaction promotion", "false",laccion1, ltipoSuc, lsucursal, lfechaInicio, lfechaFin);
                //sp_RepSocios_awm 'servername', 'remote proc transaction promotion', 'false', 'DETSUC',1,'QTT','01/01/2020','31/01/2020'
                grvSocios.DataBind();

                //grvTotalSocios.DataSource = dc.sp_TotalRepSocios_awm(laccion2, ltipoSuc, lsucursal, lfechaInicio, lfechaFin);
        ...
        if (ltipo == "2")
        {
            grvSocios.DataSource = dc.sp_RepSocios(laccion1, ltipoSuc, lsucursal, lfechaInicio, lfechaFin);
            grvSocios.DataBind();

            grvTotalSocios.DataSource = dc.sp_TotalRepSocios(laccion2, ltipoSuc, lsucursal, lfechaInicio, lfechaFin);
            grvTotalSocios.DataBind();

...
public partial class secretariaAcademica_serieTitulos : System.Web.UI.Page
{
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        ...
        string acto = lblNuevo.Text.Trim();
        string Accion = string.Empty;
        int asignado = 0;

        if (acto == "N") {
            Accion = "MODIFICAR";
            asignado = Convert.ToInt32(txtUlimoNum.Text);
        }
        else
        {
            Accion = "AGREGAR";

...
public partial class secretariaAcademica_imprimirActaEntregaTitulos : System.Web.UI.Page
{
    ...
    protected void certificado()
    {
        ...
        lblAl.Text = Convert.ToString(Session["pAl"]) + " serie " + Convert.ToString(Session["pAlterno"]);

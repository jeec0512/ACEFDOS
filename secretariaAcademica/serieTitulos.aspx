<%@ Page Title="" Language="C#" MasterPageFile="~/secretariaAcademica/mpSecretariaAcademica.master" AutoEventWireup="true" CodeFile="serieTitulos.aspx.cs" 
    Inherits="secretariaAcademica_serieTitulos" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnActualizacion" runat="server">
       ...
       <asp:Label ID="lblNuevo" CssClass="lblFormAviso" runat="server" Text="" Visible="false"></asp:Label>

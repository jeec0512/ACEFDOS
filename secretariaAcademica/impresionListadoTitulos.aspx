<%@ Page Language="C#" AutoEventWireup="true" CodeFile="impresionListadoTitulos.aspx.cs" Inherits="secretariaAcademica_impresionListadoTitulos" %>
...
<body>
    ...
    <header class="header-main">
                ...
                <div class="header-det">
                    <div class="header-det">
                        <asp:Label ID="lblTitulo" runat="server" Text="AGENCIA NACIONAL DE TRANSPORTE TERRESTRE, TRANSITO Y SEGURIDAD VIAL"></asp:Label>
                    </div>
                ...
                <asp:Panel ID="Panel1" runat="server">
                    ...
                    <asp:GridView ID="grvCursoDetalle" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="MATRICULA" Visible="false" headertext= "Matrícula"/>
                            ...
                            <asp:BoundField DataField="RNOTC_EDUC_VIAL_ASIS" Visible="true" headertext= "AEVial"/>
                             <asp:BoundField DataField="MEC_NOTA" Visible="false" headertext= "Mecánica Not1"/>
                            <asp:BoundField DataField="MEC_SUP1" Visible="false" headertext= "Sup1"/>
                            <asp:BoundField DataField="MEC_SUP2" Visible="false" headertext= "Sup2"/>
                            <asp:BoundField DataField="RNOTC_MEC_ASIS" Visible="true" headertext= "AMec"/>
                            <asp:BoundField DataField="PAUX_NOTA" Visible="false" headertext= "PrimAuxilios Not1"/>
                            <asp:BoundField DataField="PAUX_SUP1" Visible="false" headertext= "Sup1"/>
                            <asp:BoundField DataField="PAUX_SUP2" Visible="false" headertext= "Sup2"/>
                            <asp:BoundField DataField="RNOTC_PAUX_ASIS" Visible="true" headertext= "APAux"/>
                             <asp:BoundField DataField="PSIC_NOTA" Visible="false" headertext= "Psicología Not1"/>
                            <asp:BoundField DataField="PSIC_SUP1" Visible="false" headertext= "Sup1"/>
                            <asp:BoundField DataField="PSIC_SUP2" Visible="false" headertext= "Sup2"/>
                            <asp:BoundField DataField="RNOTC_PSIC_ASIS" Visible="true" headertext= "APsic"/>
                            <asp:BoundField DataField="RNOTC_PRAC_NOTA" Visible="true" headertext= "Práctica"/>
                            ...
                            <asp:BoundField DataField="RNOTC_PRAC_ASIS" Visible="true" headertext= "APrac"/>

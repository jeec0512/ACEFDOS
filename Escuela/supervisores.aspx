<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="supervisores.aspx.cs" Inherits="Escuela_supervisores"  %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true" style="width:110%;overflow:auto;">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Ingreso de notas</legend>
             ...
             <iframe id="ifControlEst" src=" http://www.aneta.org.ec:8080/AnetaWebGrades/IngresoNotas.aspx?prmfid=1" runat="server" width="100%" height="800px" frameborder="0"></iframe>

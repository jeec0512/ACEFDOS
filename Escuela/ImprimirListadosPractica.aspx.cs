...
public partial class Escuela_ImprimirListadosPractica : System.Web.UI.Page
{
    ...
    protected void listado()
    {
        ...
        */
        ...
        int modalidad = Convert.ToInt32(Session["pModalidad"]);
        int curso = Convert.ToInt32(Session["pCurso"]);
        int vehiculo = Convert.ToInt32(Session["pVehiculo"]);
        int materia = Convert.ToInt32(Session["pMateria"]);
        int hora = Convert.ToInt32(Session["pHora"]);
        ...
        var cEscuela = ds.sp_abmEscuela("CONSULTAR", 0, "", "", "", 0, escuela);
        ...
        var cFechaCur = ds.sp_abmCurso("CONSULTAR", curso, 0, "", "", DateTime.Now, DateTime.Now, false, "", DateTime.Now);
        foreach (var regCliente in cFechaCur.ToList())
        {
            ...
            //txtFechaInicio.Text = Convert.ToString(regCliente.CUR_FECHA_INICIO);
            //txtFechaFin.Text = Convert.ToString(regCliente.CUR_FECHA_FIN);
        }

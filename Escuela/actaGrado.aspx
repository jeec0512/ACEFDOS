<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="actaGrado.aspx.cs" Inherits="Escuela_actaGrado" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <div class="main-activarCurso">
        ...
        <div class="areaActivarCurso main-principalActivarCurso item">
            ...
            <div class="areaBotones main-principalActivarCurso__botonera subitem" visible="false" runat="server">
                <div class="contieneBotones">
                    <h3 class="titulo3">Acciones</h3>
                    <div class="cajaBotones">
                        <div class="buttonHolder">
                            <asp:Button ID="btnGuardar" runat="server" CssClass="button button-title" Text="Guardar" BorderStyle="None" Visible="false" />
                            <asp:Button ID="btnCancelar" runat="server" CssClass="button button-title" Text="Cancelar" BorderStyle="None" Visible="false" />
                            <asp:Button ID="btnImprimir2" runat="server" CssClass="button button-title" Text="Imprimir" BorderStyle="None" Visible="true" />
                ...
                <asp:GridView ID="grvCursoDetalle" runat="server" AutoGenerateColumns="False" CellPadding="5" GridLines="Vertical" HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblIdActivar" runat="server" Text='<%# Bind("RNOTC_id") %>' CssClass="noDesplegar"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:BoundField DataField="RNOTC_id" HeaderText="ID" ItemStyle-CssClass="DisplayNone" HeaderStyle-CssClass="DisplayNone" Visible="false" />
                        ...
                        <asp:ButtonField HeaderText="Imprimir" Text="..." ButtonType="Image"
                            ImageUrl="~/images/iconos/144.ico" CommandName="imprimeReg" ItemStyle-Width="10px" Visible="true">
                    ...
                    <div class="contieneBotones">
                        ...
                        <div class="cajaBotones">
                            <div class="buttonHolder">
                                ...
                                <asp:Button ID="btnImprimir" runat="server" CssClass="button button-title" Text="Imprimir" BorderStyle="None" OnClick="btnImprimir_Click1" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Escuela/mpEscuela.master" AutoEventWireup="true" CodeFile="disponibilidadHorarios.aspx.cs"
    Inherits="Escuela_disponibilidadHorarios" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnHojas" CssClass="" runat="server" Visible="true">
        ...
        <asp:Button ID="btnMatricula" runat="server" Text="Ocultar Matrícula" OnClick="btnMatricula_Click" Visible="false" />
        <asp:Button ID="btnHorario" runat="server" Text="Ocultar Horario" OnClick="btnHorario_Click" Visible="false" />
        <asp:Button ID="btn_abmAlumno" runat="server" Text="Ocultar Alumno" OnClick="btn_abmAlumno_Click" Visible="false" />
    ...
    <asp:Panel ID="pnFacturaGral" CssClass="" runat="server" Visible="false">
    ...
    <asp:Panel ID="pnMatricula" CssClass="" runat="server" Visible="true">
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <asp:Panel ID="pnAlumno" runat="server" CssClass="pnFormSocio" GroupingText="" ForeColor="#0033cc" Visible="false">
            ...
            <asp:Panel ID="pnEscuela" runat="server" CssClass="pnFormSocio" GroupingText="" ForeColor="#0033cc">
                <asp:Panel ID="pnAsignacion" runat="server">
                    <fieldset id="fsAsignacion">
                        ...
                        <asp:Panel ID="pnCiudad" runat="server" CssClass="pnFormDdl" Visible="true">
                            <asp:DropDownList ID="ddlCiudad" DataTextField="ciudad" DataValueField="ciudad" runat="server"
                                AutoPostBack="True" Style="font-size: 0.7rem; width: 80%" OnSelectedIndexChanged="ddlCiudad_SelectedIndexChanged">
                            </asp:DropDownList>
                        </asp:Panel>
            ...
            <asp:Panel ID="pnLinkAlumno" runat="server" CssClass="pnFormSocio" GroupingText="" ForeColor="#0033cc" Visible="false">
                ...
                <fieldset id="fsPractica">
                    ...
                    <!--<asp:Button runat="server" ID="btnPrac" CssClass="c-activa text" Text="Práctica" />
                        ...
                        <asp:Panel ID="pnModPractica" runat="server" CssClass="pnFormDdl">
                            <asp:DropDownList ID="ddlModPractica" DataTextField="mod_descripcion" DataValueField="mod_id" runat="server"
                    ...
                    <asp:Panel ID="pngrvAutoDetalle" runat="server" Style="max-height: 200px; overflow-y: scroll; margin-bottom: 1.5rem;">
                        <asp:GridView ID="grvAutoDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                            ...
                            <Columns>
                                <asp:BoundField DataField="HOR_INICIO" HeaderText="Hor_Ini" Visible="true" />
                                <asp:BoundField DataField="HOR_FIN" HeaderText="Hor_fin" Visible="true" />
                                <asp:BoundField DataField="VEHICULO" HeaderText="Vehículo" Visible="true" />
                                <asp:BoundField DataField="ASM_DISPONIBLE" HeaderText="Disp." Visible="true" />
                                <asp:BoundField DataField="ASM_REGISTRADO" HeaderText="Ocup." Visible="true" />
                            </Columns>
                ...
                <asp:Panel ID="pnEducVial1" runat="server" GroupingText="" ForeColor="#0033cc">
                    <fieldset id="fsEducVial">
                        ...
                        <asp:Panel ID="pnModEducVial" runat="server" CssClass="pnFormDdl">
                            <asp:DropDownList ID="ddlModEducVial" DataTextField="mod_descripcion" DataValueField="mod_id" runat="server"
    ...
    <asp:Panel ID="pnTalleres" CssClass="" runat="server" Visible="true">
                ...
                <fieldset id="fsMecanica">
                    ...
                    <!-- <asp:Button runat="server" ID="btnMecanica" CssClass="c-activa text" Text="Mecánica" />
                        ...
                        <asp:Panel ID="pnModMecanica" runat="server" CssClass="pnFormDdl">
                            <asp:DropDownList ID="ddlModMecanica" DataTextField="mod_descripcion" DataValueField="mod_id" runat="server"
                ...
                <fieldset id="fsPrimerosAuxilios">
                    ...
                    <!--
                        <asp:Panel ID="pnModPrimerosAuxilios" runat="server" CssClass="pnFormDdl">
                            <asp:DropDownList ID="ddlModPrimerosAuxilios" DataTextField="mod_descripcion" DataValueField="mod_id" runat="server"
                ...
                <fieldset id="fsPsicologia">
                    ...
                    <!--<asp:Button runat="server" ID="btnPsico" CssClass="c-activa text" Text="Psicología" />
                        ...
                        <asp:Panel ID="pnModPsicologia" runat="server" CssClass="pnFormDdl">
                            <asp:DropDownList ID="ddlModPsicologia" DataTextField="mod_descripcion" DataValueField="mod_id" runat="server"
    ...
    <asp:Panel ID="pnAcciones" CssClass="" runat="server" Visible="false">
    ...
    <asp:Panel ID="pnCreaAlumno" runat="server" Visible="false">

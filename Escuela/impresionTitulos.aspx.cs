...
public partial class Escuela_impresionTitulos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = " http://192.168.1.124:8080/escuelaweb/control/titulo.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        // sUrl = " http://181.188.214.60:8083/escuelaweb/site/home.an?prmusrid=" + userId;

        sUrl = "  http://192.168.1.124:8080/escuelaweb/control/titulo.an?prmusrid={*usuarios}";

        string facturacion = "http://192.168.1.118:8080/escuelaweb/control/titulo.an?prmusrid=" + userId;

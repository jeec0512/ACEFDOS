...
public partial class Escuela_certificadoSicopractico : System.Web.UI.Page
{
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        /*
            string facturacion = " http://aneta.org.ec:5090/acefdos/(S(cdnllygabpz5pg03y51vudcx))/Escuela/imprimirSicopractico.aspx?id="+sucursal+factura+cedula;
            ifFacturacion.Attributes["src"] = facturacion;

        */


         sUrl = " http://aneta.org.ec:5090/acefdos/(S(cdnllygabpz5pg03y51vudcx))/Escuela/imprimirSicopractico.aspx";
    ...
    /*IMPRIMIR PSICOPRÁCTICO*/
    #region IMPRIMIR PSICOPRÁCTICO
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        string facturacion = "http://aneta.org.ec:5090/acefdos/(S(cdnllygabpz5pg03y51vudcx))/Escuela/imprimirSicopractico.aspx";

...
public partial class Escuela_asignacionHorarios : System.Web.UI.Page
{
    ...
    protected void listarAuto()
    {
        ...
        {
            Accion = "XTIPO";
            cAuto = ds.sp_abmAuto_escuela2(Accion, 0, "", "", 0, "", "", "", "", 0, false, DateTime.Now, DateTime.Now, 0, 0, "", sucursal,2);
        }
        else {
            cAuto = ds.sp_abmAuto_escuela2(Accion, 0, "", "", 0, "", "", "", "", 0, false, DateTime.Now, DateTime.Now, 0, 0, "", sucursal,1);
        }

...
//
    ...
    protected void grvCursoDetalle_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        /*bool estado;
         ...
         {
             estado = Convert.ToBoolean(grvCursoDetalle.Rows[i].Cells[16].Text);
    ...
    public bool enviarCorreoHtml(string alumno, string emailEstudiante, string factura)
    {
       ...
       // string mailDomicilio = emailEstudiante; //txtEmailDom.Text.Trim();
        ...
        string mailOficina = "sistemas@aneta.org.ec";  //"jose_espinosa3l@hotmail.com"; 
       ...
       /* string nombreSocio = "EJEMPLO";
        ...
        caminoLogo = "~//Plantillas//entregaTituloAcademico2.html";
        ...
        if (envio == "1")
        {
            destinatarios = emailEstudiante;  //"jeec1965@gmail.com,jose_espinosa3l@hotmail.com, sistemas@aneta.org.ec"; 
        ...
        if (new email().enviarCorreo("192.168.1.110", 587, "socios@aneta.org.ec", "aneta54", "ESCUELA-ANETA", destinatarios, cc, tituloEmail, anexo, emailHtml.ToString(), Filename1, Filename2, Filename3, Filename4))
        {
    ...
    protected void btnLegalizar_Click(object sender, EventArgs e)
    {
        string sucursal = ddlSucursal.SelectedValue;
        int cur_id = Convert.ToInt32(ddlCurso.SelectedValue);
        string pedido = ddlPedido.SelectedValue.Trim();
        string accion = "LEGALIZAR";
        ds.sp_legalizarTitulos(accion, sucursal, cur_id, pedido);
    }
}
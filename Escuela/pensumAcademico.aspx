...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="pnDatos" CssClass="pnPeqSoc" runat="server" Visible="true" style="display:inline-block">
                ...
                <asp:Button runat ="server" ID ="btnActual" Text="Pensum" OnClick="btnActual_Click"/>
                <asp:Button runat ="server" id="btnAnterior" Text="Datos históricos antes 2016" OnClick="btnAnterior_Click"/>
                ...
                <!--<asp:ImageButton ID="imgBuscar" runat="server" ImageUrl="~/images/iconos/219.png" Width="27px" ToolTip="Buscar"
                 ...
                 <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/iconos/219.png" Width="27px" ToolTip="Buscar"
                    BorderColor="#9aaff1" OnClick="imgBuscar_Click" />-->
    ...
    <asp:Panel ID="pnGeneral" CssClass="" runat="server" Visible="true">
        <asp:Panel ID="pnEstudiante" runat="server"
            ScrollBars="Vertical" Wrap="False" GroupingText="Pensum">
            <asp:GridView ID="grvEstudiante" runat="server" AutoGenerateColumns="False" CellPadding="5" GridLines="Vertical"
                ...
                <Columns>
					...
					<asp:BoundField DataField="nom_suc" HeaderText="Escuela" Visible="true" />
                    <asp:BoundField DataField="alu_identificacion" HeaderText="#Identificación" Visible="true" />
                    <asp:BoundField DataField="alu_APELLIDOS" HeaderText="Apellidos" Visible="true" />
                    <asp:BoundField DataField="alu_NOMBRES" HeaderText="Nombres" Visible="true" />
                    <asp:BoundField DataField="CURSOANT" HeaderText="Curso ANT" Visible="true" />
                    <asp:BoundField DataField="CURSOREAL" HeaderText="Curso ANETA" Visible="true" />
                    <asp:BoundField DataField="TL_TIPOLICENCIA" HeaderText="LIC" Visible="true" />
                    <asp:BoundField DataField="REG_FACTURANUMERO" HeaderText="#FACT" Visible="true" />
                    <asp:BoundField DataField="fac_estado" HeaderText="EstadoFACT" Visible="true" />
                    <asp:BoundField DataField="saldo" HeaderText="Saldo" Visible="true" />
                    ...
                    <asp:BoundField DataField="RNOTC_CONFIRMACION" HeaderText="Legalizado" Visible="true" />
                    ...
                    <asp:BoundField DataField="RNOTC_EDUC_VIAL_ESTA" HeaderText="RNOTC_EDUC_VIAL_ESTA" Visible="false" />
                    ...
                    <asp:BoundField DataField="RNOTC_PRAC_ESTA" HeaderText="RNOTC_PRAC_ESTA" Visible="false" />
                    <asp:BoundField DataField="RNOTC_PSIC_ASIS" HeaderText="APSIC" Visible="true" />
                    <asp:BoundField DataField="RNOTC_PSIC_ESTA" HeaderText="RNOTC_PSIC_ESTA" Visible="false" />
                    <asp:BoundField DataField="RNOTC_PAUX_ASIS" HeaderText="APAUX" Visible="true" />
                    <asp:BoundField DataField="RNOTC_PAUX_ESTA" HeaderText="RNOTC_PAUX_ESTA" Visible="false" />
                    <asp:BoundField DataField="RNOTC_MEC_ASIS" HeaderText="AMEC" Visible="true" />
                    <asp:BoundField DataField="RNOTC_MEC_ESTA" HeaderText="RNOTC_MEC_ESTA" Visible="false" />
                  ...
                  <asp:BoundField DataField="RNOTC_OBSERVACIONES" HeaderText="OBSERVACIONES" Visible="true" />
                   ...
                   <asp:BoundField DataField="RNOTC_OP1" HeaderText="RNOTC_OP1" Visible="false" />
                    ...
                    <asp:BoundField DataField="RNOTC_PEDIDO_TITULOS" HeaderText="#PEDTIT" Visible="true" />
        ...
        <asp:Panel ID="pnHistorico" CssClass="" runat="server" Visible="true" ScrollBars="Vertical" Wrap="False" GroupingText="Antes del 2016">
            <asp:GridView ID="grvHistorico" runat="server" AutoGenerateColumns="False" CellPadding="5" GridLines="Vertical"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ped_tit" HeaderText="ped_tit" Visible="true" />

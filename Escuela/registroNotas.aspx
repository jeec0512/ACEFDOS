...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <iframe id="ifIngNotas" src="http://www.aneta.org.ec:8080/ASIGNOT/WFNotasEstudiante.aspx?prm=64" runat="server" width="100%" height="800px" frameborder="0" visible="false"></iframe>
            <iframe id="ifGeneral" src="http://www.aneta.org.ec:8080/ASIGNOT/WFNotasEstudiante.aspx?prm=64" runat="server" width="100%" height="800px" frameborder="0" visible="false"></iframe>
            <iframe id="ifEspecifico" src="http://www.aneta.org.ec:8080/ASIGNOT/WFNotasEstudiante.aspx?prm=64" runat="server" width="100%" height="800px" frameborder="0" visible="false"></iframe>

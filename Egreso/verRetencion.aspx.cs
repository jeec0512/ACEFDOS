...
public partial class Egreso_verRetencion : System.Web.UI.Page
{
    ...
    protected void btnTraerRetencion_Click()
    {
        ...
        if (sihay == 1)
        {
            ...
            if (lcre_sri == "AUTORIZADO" || lcre_sri == "ANULADO" || lcre_sri.ToUpper() != "ANULADO")
            {
                desactivarBotones();
                if (lcre_sri == "ANULADO")
                {
                ...
                if ((lcre_sri.ToUpper() == "AUTORIZADO" || lcre_sri.ToUpper() != "ANULADO") && tipo == 4)
                {
                    btnAnularRet.Visible = true;
                }
            }
            ...
            lblMensaje.Text = "No existe el documento";
        }
    }

...
public partial class Egreso_cajasEgresos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = "http://www.aneta.org.ec:9095/app/account/caja.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = "  http://www.aneta.org.ec:9095/app/account/caja.an?prmusrid=" + userId;

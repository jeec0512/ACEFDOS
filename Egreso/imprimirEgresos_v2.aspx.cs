...
public partial class Egreso_imprimirEgresos_v2 : System.Web.UI.Page
{
    ...
    protected void cierreCaja()
    {
        ...
        string lAccion = "XFECHA";
         ...
         cEgresos = dc.sp_ListarDetalleGasto_v2(lAccion, lsuc, lFechaInicio, lFechaFin, lCaja, 0);
        /*var cEgresos = dc.sp_conmutarControlEgresos(lAccion, lsuc, lFechaInicio, lFechaFin, lCaja, 0);

        if (lsucursal == "QTE")
        {
            cEgresos = dc.sp_conmutarControlEgresos(lAccion, lsuc, lFechaInicio, lFechaFin, lCaja, 0);
        }
        else
        {
            cEgresos = dc.sp_conmutarControlEgresos(lAccion, lsuc, lFechaInicio, lFechaFin, lCaja, 0);
    ...
    protected void grvEgresosDetalle_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            subtotal += Convert.ToDecimal(e.Row.Cells[7].Text);
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[7].Text = Convert.ToString(subtotal);

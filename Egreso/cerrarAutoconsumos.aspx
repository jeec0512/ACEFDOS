<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="cerrarAutoconsumos.aspx.cs" Inherits="Egreso_cerrarAutoconsumos"  EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Cierre de AUTOCONSUMOS</legend>
            <asp:Panel ID="pnDatos" CssClass="pnPeq" runat="server" Visible="true">
                ...
                <asp:DropDownList ID="ddlSucursal2" runat="server" CssClass="peqDdl" DataTextField="nom_suc" DataValueField="sucursal">
                 ...
                 <asp:Panel ID="pnCaja" runat="server" CssClass="pnFormDdl" Visible="false">
                ...
                <asp:Button ID="btnImprimir" runat="server" CssClass="btnProceso"  Text="Imprimir documentos SRI" OnClick="btnImprimir_Click"  Visible="false"/>
                <asp:Button ID="btnImprimirAuto" runat="server" CssClass="btnProceso" Text="Imprimirautoconsumos" OnClick="btnImprimirAuto_Click"  />
                <asp:Button ID="btnMemos" runat="server" CssClass="btnProceso"  Text="Imprimir documentos sin validez tributaria" OnClick="btnMemos_Click" Visible="false" />

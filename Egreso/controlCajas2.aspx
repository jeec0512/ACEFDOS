        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <asp:GridView ID="grvEgresosDetalle_v2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    ...
                    <asp:ButtonField HeaderText="Ver retención" Text="..." ButtonType="Image" ImageUrl="~/images/iconos/ohist.ico"
                        CommandName="verRet_v2" ItemStyle-Width="60" />
                    <asp:BoundField DataField="id_detegresos" HeaderText="id_detegresos" Visible="true" ItemStyle-CssClass="DisplayNone"
                        HeaderStyle-CssClass="DisplayNone" />
                    <asp:BoundField DataField="numero" HeaderText="# Caja" Visible="true"  />
                    <asp:BoundField DataField="fecha" HeaderText="Fecha emisión Documento" Visible="true" DataFormatString="{0:d}" />
                    <asp:BoundField DataField="numerodocumento" HeaderText="# Documento" Visible="true"  />
                    <asp:BoundField DataField="doc_autorizacion" HeaderText="# Autorización Documento" Visible="true"  />
                    <asp:BoundField DataField="fechacaducdoc" HeaderText="Fecha caducidad Documento" Visible="true" DataFormatString="{0:d}"/>
                    <asp:BoundField DataField="dgas_item" HeaderText="Producto" Visible="true"  />
                    <asp:BoundField DataField="dgas_valor" HeaderText="Subtotal" Visible="true"  />
                    <asp:BoundField DataField="IVA" HeaderText="I.V.A." Visible="true"  />
                    <asp:BoundField DataField="total" HeaderText="Total" Visible="true"  />
                    <asp:BoundField DataField="TOTAL_A_PAGAR" HeaderText="Total a pagar" Visible="true"  />
                    <asp:BoundField DataField="CODIGO_CUENTA_CONTABLE" HeaderText="Cód. Cuenta Contable" Visible="true"  />
                    <asp:BoundField DataField="NOMBRE_CUENTA_CONTABLE" HeaderText="Desc. Cuenta Contable" Visible="true"  />
                    <asp:BoundField DataField="numretencion" HeaderText="# Retencion" Visible="true"  />
                    <asp:BoundField DataField="ID_RETENCION" HeaderText="Código interno" Visible="true"  />

<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="controlEgresosRetencion.aspx.cs"
    Inherits="Egreso_controlEgresosRetencion" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <!-- DETALLE EGRESOS VERSION 2  !-->
    <asp:Panel ID="pnDetalleCaja_v2" CssClass="" runat="server" Visible="true">

        <fieldset id="Fieldset1" class="fieldset-principal">
            <legend></legend>
            <asp:GridView ID="grvEgresosDetalle_v2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Vertical" HorizontalAlign="Center"
                Width="90%"
                AllowSorting="True" PageSize="50" OnRowCommand="grvEgresosDetalle_v2_RowCommand"
                OnRowDataBound="grvEgresosDetalle_v2_RowDataBound" ShowFooter="false">
                <AlternatingRowStyle BackColor="#DCDCDC" />
                <Columns>
                    <asp:BoundField HeaderText="RUC" DataField="ruc" Visible="true" />
                    <asp:BoundField HeaderText="Fecha documento" DataField="fechaemisiondoc" Visible="true" DataFormatString="{0:d}" />
                    <asp:BoundField HeaderText="Fecha Caducidad/Doc" DataField="fechacaducdoc" Visible="true" DataFormatString="{0:d}" />
                    <asp:BoundField HeaderText="# Documento" DataField="numerodocumento" Visible="true" />
                    <asp:BoundField HeaderText="# Autorización documento" DataField="doc_autorizacion" Visible="true" />
                    ...
                    <asp:BoundField DataField="totaliva" HeaderText="I.V.A." Visible="true" />
                    <asp:BoundField DataField="fechaemisionret" HeaderText="Fecha emisión retención" Visible="true"  DataFormatString="{0:d}" />
                    <asp:BoundField DataField="numAutorizacionretencion" HeaderText="# Autorización retención" Visible="true" />
                    <asp:BoundField DataField="fuente" HeaderText="Ret.Fuente" Visible="true" />
                    <asp:BoundField DataField="iva" HeaderText="Ret.IVA" Visible="true" />
                    <asp:BoundField DataField="totalretenido" HeaderText="Total retenido" Visible="true" />
                </Columns>
                <FooterStyle BackColor="White" ForeColor="Red" Font-Bold="True" Font-Size="Medium"
                    Font-Strikeout="False" />
                <HeaderStyle BackColor="#0C80BF" Font-Bold="True" ForeColor="White" />
             ...
             <asp:GridView ID="grvTotales_v2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Vertical" HorizontalAlign="Center"
                Width="90%"
                AllowSorting="True" PageSize="50" ShowFooter="false">
                <AlternatingRowStyle BackColor="#DCDCDC" />
                <Columns>
                    <asp:BoundField HeaderText="Caja" DataField="numero_caja" Visible="true"  />
                    <asp:BoundField HeaderText="Total gasto" DataField="total_gasto" Visible="true"  />
                    <asp:BoundField HeaderText="Total retención" DataField="total_retencion" Visible="true"  />
                    <asp:BoundField HeaderText="Valor a pagar" DataField="valor_a_pagar" Visible="true"  />

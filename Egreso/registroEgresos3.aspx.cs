...
public partial class Egreso_registroEgresos3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = "http://www.aneta.org.ec:9095/app/site/egresos.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = "  http://192.168.1.124:8080/app/site/egresos.an?prmusrid=" + userId;

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imptimirRetencion_v2.aspx.cs" Inherits="Egreso_imptimirRetencion_v2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <header>
                <section id="logo">
                    <img src="../images/iconos/icoaneta3.png" style="width:50px;height:80px;" />
                </section>
                <section id="identificacion">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="lbl" Text="AUTOMOVIL CLUB DEL ECUADOR ANETA"></asp:Label>

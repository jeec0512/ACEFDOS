...
public partial class Egreso_registroEgresos : System.Web.UI.Page
{
    ...
    protected void ddlDocRet_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            var SSubT = from mInfo in dc.tbl_infotributaria
                        join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                        join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                        join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion

                        where mInfo.id_infotributaria == id
                           && mRet.codDocSustento == docRet
                           && mRet.SB.Substring(0, 1) == "S"
                        select new
                        {
                            servicio = mRet.baseImponible,
                            mae_gas = mRet.mae_gas,
                            codcble = mRet.codcble,
                            descrip = mAdic.campoAdicional.Trim(),
                             emision = mRet.fechaEmisionDocSustento,
                            caducidad = mRet.fechaCaducidadDocSustento,
                  //          subTotal = c.totalFactura*100/112,
                            iva = mInfo.totalFactura - (mInfo.totalFactura * 100 / 112)
            ...
            var BSubT = from mInfo in dc.tbl_infotributaria
                        join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                        join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                        join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion
                        ...
                        where mInfo.id_infotributaria == id
                           && mRet.codDocSustento == docRet
                           && mRet.SB.Substring(0, 1) == "B"
                        select new
                        {
                            bien = mRet.baseImponible,
                            mae_gas = mRet.mae_gas,
                            codcble = mRet.codcble,
                            descrip = mAdic.campoAdicional.Trim(),
                            emision = mRet.fechaEmisionDocSustento,
            ...
            /*var BSubTotal = from mInfo in dc.tbl_infotributaria
                            join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                            join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                            join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion
                            ...
                            where mInfo.id_infotributaria == id
                               && mRet.codDocSustento == docRet
                               && mRet.SB.Substring(0, 1) == "B12"
                                && mRet.codigo == 1
                        select new
                        {
                            subTotal = mRet.baseImponible
                        };*/

            var BSubTotal = dc.sp_baseImponibleRetencion(id, docRet, "B12", "1");
            ...
            //{
                ...
                {
                    lsubtotalBien = registro.baseImponible;
                }
            //}
            /**IVA CERO BIENES*/
            /*var BceroBien = from mInfo in dc.tbl_infotributaria
                            join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                            join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                            join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion
            ...
            var BceroBien = dc.sp_baseImponibleRetencion(id, docRet, "B0", "1");
            // if (BceroBien.Count() <= 0)
             ...
             //{
                 ...
                 {
                     lceroBien = registro.baseImponible;
                 }
             //}
            /**OTROS BIENES*/
                /*NO EXISTE*/
            /**SUBTOTAL SERVICIOS*/
             /*var SsubtotalServicio = from mInfo in dc.tbl_infotributaria
                                     join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                                     join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                                     join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion
             ...
             var SsubtotalServicio = dc.sp_baseImponibleRetencion(id, docRet, "S12", "1");
             ...
             foreach (var registro in SsubtotalServicio)
                 {
                     lsubtotalServicio = registro.baseImponible;
                 }
             //}
            /**IVA CERO SERVICIOS*/
            /* var SceroServicio = from mInfo in dc.tbl_infotributaria
                                 join mComp in dc.tbl_infoCompRetencion on mInfo.id_infotributaria equals mComp.id_infotributaria
                                 join mRet in dc.tbl_impuestosRet on mComp.id_infoCompRetencion equals mRet.id_infoCompRetencion
                                 join mAdic in dc.tbl_infoAdicional on mComp.id_infoCompRetencion equals mAdic.id_infoCompRetencion
             ...
             var SceroServicio = dc.sp_baseImponibleRetencion(id, docRet, "S0", "1");
             ...
             foreach (var registro in SceroServicio)
                 {
                     lceroServicio = registro.baseImponible;
                 }
             //}
            /**OTROS SERVICIOS*/
             /*NO EXISTE*/
            ...
            /* **********************************************************************************************/
             ...
             txtBsubtotal.Text = Convert.ToString(lsubtotalBien);
             txtBtarifa0.Text = Convert.ToString(lceroBien);

             txtSsubtotal.Text = Convert.ToString(lsubtotalServicio);
             txtStarifa0.Text = Convert.ToString(lceroServicio);

...
public partial class Egreso_mpEgreso : System.Web.UI.MasterPage
{
    ...
    protected void calificarOpciones()
    {
		...
		submenu = "REGEGRESOS3";
        lRegEgresos3.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);
        ...
        lResumenEgresos.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);
		 ...
		 submenu = "CIERREAUTOCONSUMO";
         lCerrarAutoconsumo.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);
        

		submenu = "CAJASEGRESOS";
		lCajasEgresos.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

        submenu = "CTRLEGRESOSRETENCION";
		lCtrlEgresoRetencion.Visible = LoginService.calificarOpcion(accion, grupo, menu, submenu, boton);

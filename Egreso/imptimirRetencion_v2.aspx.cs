...
public partial class Egreso_imptimirRetencion_v2 : System.Web.UI.Page
{
    ...
    protected void cierreCaja()
    {
        ...
        string lidRet = Convert.ToString(Session["pIdRetencion"]);
       int lnumret = Convert.ToInt32(lidRet);
        ...
        //mCabRet.CRE_ESTABLECIMIENTO + mCabRet.CRE_PUNTOEMISION + mCabRet.CRE_SECUENCIAL == lRetencion
         //&& mCabRet.CRE_ESTADO == "A"
        var cCabRet = from mCabRet in df.COMPROBANTERETENCION
                      where mCabRet.CRE_ID ==  lnumret
                      select new
                      {
        ...
        var cDetRet = dc.sp_detalleRtencion_v2(lRetencion, lnumret);

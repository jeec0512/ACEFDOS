...
public partial class Escuela_guardarArchivos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string camino = "~/admArchivos/escuela/" + sucursal.ToLower() + "/";
    ...
    protected void btnCargar_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Escuela/guardarArchivos_ANETA.aspx");
    }
    ...
    {
        Response.Redirect("~/Escuela/verImagen_ANETA.aspx?ImageURL=" + ((ImageButton)sender).ImageUrl);
    }

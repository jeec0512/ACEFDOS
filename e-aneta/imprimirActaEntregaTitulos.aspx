<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imprimirActaEntregaTitulos.aspx.cs" Inherits="Escuela_imprimirActaEntregaTitulos" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <header>
                <div class="padre">
                    <img src="../images/iconos/anetatitulo2.jpg" />
                </div>
                ...
                <div class="padre">
                    <asp:Label ID="lblSubtitulo" runat="server" CssClass="lblCentrado" Text="No. de convenio de autorización 002"
            ...
            <nav class="fin">
                ...
                <div class="posData">
                    <img runat="server" id="imgCtrl" heght="150" width="150" />
